...
func (s *RefreshStore) Save(ctx context.Context, userID int64, jti string, ttl time.Duration) error {
	if jti == "" {
...
func (s *RefreshStore) IsActive(ctx context.Context, userID int64, jti string) (bool, error) {
...
func (s *RefreshStore) Revoke(ctx context.Context, userID int64, jti string) error {
