...
func lookupUserByEmail(ctx context.Context, pool *pgxpool.Pool, email string) (uint64, uint64, string, bool, error) {
	var (
		id       uint64
		tenantID uint64
		hash     string
...
func loadRolesAndPerms(ctx context.Context, pool *pgxpool.Pool, tenantID, userID uint64) ([]int64, []string, error) {
